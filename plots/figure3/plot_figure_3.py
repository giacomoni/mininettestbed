...
ROOT_PATH = "/Volumes/LaCie/mininettestbed/nooffload/results_fairness_inter_rtt_async/fifo"
...
for mult in QMULTS:
   ...
   for format in ['pdf', 'png']:
      plt.savefig('goodput_ratio_async_inter_20_%s.%s' % (mult, format), dpi=720)
