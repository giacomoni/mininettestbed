            ...
            for mult in QMULTS:
               ...
               for run in RUNS:
                  ...
                  if os.path.exists(PATH + '/csvs/x1.csv') and os.path.exists(PATH + '/csvs/x2.csv'):
                     ...
                     avg_goodput = (receiver1['bandwidth'] + receiver2['bandwidth']).mean()
                     std_goodput = (receiver1['bandwidth'] + receiver2['bandwidth']).std()
                     jain_goodput_20 = receiver2['bandwidth'].mean() / receiver1['bandwidth'].mean()
                     jain_goodput_total = receiver2_total['bandwidth'].mean() / receiver1_total[
                        'bandwidth'].mean()
      ...
      for run in RUNS:
         ...
         if os.path.exists(PATH + '/csvs/x1.csv') and os.path.exists(PATH + '/csvs/x2.csv'):
            ...
            if sync:
               ...
               ratio_tmp =  pd.concat([receiver_start/receiver_start, receiver2_middle / receiver1_middle, receiver_end/receiver_end])
