...
markers, caps, bars = ax.errorbar(cubic_data.index*2, cubic_data['rtt_20_mean'], yerr=cubic_data['rtt_20_std'],marker='x',linewidth=LINEWIDTH, elinewidth=ELINEWIDTH, capsize=CAPSIZE, capthick=CAPTHICK, label='cubic')
[bar.set_alpha(0.5) for bar in bars]
[cap.set_alpha(0.5) for cap in caps]
markers, caps, bars = ax.errorbar(orca_data.index*2,orca_data['rtt_20_mean'], yerr=orca_data['rtt_20_std'],marker='^',linewidth=LINEWIDTH, elinewidth=ELINEWIDTH, capsize=CAPSIZE, capthick=CAPTHICK,label='orca', linestyle='--')
[bar.set_alpha(0.5) for bar in bars]
[cap.set_alpha(0.5) for cap in caps]
markers, caps, bars = ax.errorbar(aurora_data.index*2,aurora_data['rtt_20_mean'], yerr=aurora_data['rtt_20_std'],marker='+',linewidth=LINEWIDTH, elinewidth=ELINEWIDTH, capsize=CAPSIZE, capthick=CAPTHICK,label='aurora', linestyle='-.')
[bar.set_alpha(0.5) for bar in bars]
[cap.set_alpha(0.5) for cap in caps]

ax.set(yscale='linear',xlabel='Min. RTT (ms)', ylabel='Avg. RTT Gain')
for axis in [ax.xaxis, ax.yaxis]:
    axis.set_major_formatter(ScalarFormatter())
ax.legend(loc=4)
# ax.grid()

plt.savefig('rtt_gain_async_intra_20_%s.png' % mult, dpi=720)
...
markers, caps, bars = ax.errorbar(cubic_data.index*2,cubic_data['rtt_total_mean'], yerr=cubic_data['rtt_total_std'],marker='x',elinewidth=ELINEWIDTH, capsize=CAPSIZE, capthick=CAPTHICK,linewidth=LINEWIDTH, label='cubic')
[bar.set_alpha(0.5) for bar in bars]
[cap.set_alpha(0.5) for cap in caps]
markers, caps, bars = ax.errorbar(orca_data.index*2,orca_data['rtt_total_mean'], yerr=cubic_data['rtt_total_std'],marker='^',linewidth=LINEWIDTH, elinewidth=ELINEWIDTH, capsize=CAPSIZE, capthick=CAPTHICK,label='orca', linestyle='--')
[bar.set_alpha(0.5) for bar in bars]
[cap.set_alpha(0.5) for cap in caps]
markers, caps, bars = ax.errorbar(aurora_data.index*2,aurora_data['rtt_total_mean'], yerr=aurora_data['rtt_total_std'],marker='+',linewidth=LINEWIDTH, elinewidth=ELINEWIDTH, capsize=CAPSIZE, capthick=CAPTHICK,label='aurora', linestyle='-.')
[bar.set_alpha(0.5) for bar in bars]
[cap.set_alpha(0.5) for cap in caps]
...
plt.savefig('rtt_gain_async_intra_%s.png' % mult, dpi=720)
